...
The *Serial Receive* block splits up the input and writes the values to the corresponding variables. The input includes data like PID values and the mode set by the user.
