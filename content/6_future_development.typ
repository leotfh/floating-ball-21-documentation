...
Since the height of different tubes is never the exact same it would be advantageous to set the offset distance between sensor and ball automatically when the ball is lying still.